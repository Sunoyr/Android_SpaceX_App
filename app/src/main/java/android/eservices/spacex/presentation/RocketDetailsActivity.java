...
public class RocketDetailsActivity extends AppCompatActivity {
    ...
    private void setupView() {
        ...
        height.setText(getResources().getString(R.string.rocket_height)+" "+rocket.getHeight()+" meters");

        TextView diameter = v.findViewById(R.id.rocket_diameter_textView);
        diameter.setText(getResources().getString(R.string.rocket_diameter)+" "+rocket.getDiameter()+" meters");

        TextView mass = v.findViewById(R.id.rocket_mass_textView);
        mass.setText(getResources().getString(R.string.rocket_mass)+" "+rocket.getMass()+" Kg");

        TextView engines = v.findViewById(R.id.rocket_engines_textView);
        engines.setText(getResources().getString(R.string.rocket_engines)+" "+Math.round(rocket.getEngines()));
